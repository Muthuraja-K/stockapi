#!/usr/bin/env python3
"""
Test script to verify the after earning calculation for MDB on the specific date 06/04/2025
"""
...
def test_mdb_specific_date():
    """Test the after earning calculation for MDB on 06/04/2025"""
    
    ticker = "MDB"
    # Use the specific date mentioned by the user
    earning_date = datetime(2025, 6, 4)  # 06/04/2025
    ...
    try:
        ...
        if price_755pm is None:
            print("❌ 7:55 PM not found, searching for any after-hours price after 4:00 PM...")
            for timestamp, row in earning_date_data.iterrows():
